This demo shows 4bpp sprites in 2D mode.
...
nin10kit then forms a 2D spritesheet (256px x 256px) from the tiles.  Calculates the sprite offsets and other properties (palette id, shape, size, etc) and emit #defines
